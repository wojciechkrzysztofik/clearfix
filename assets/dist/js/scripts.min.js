...
$(document).ready(function(){var i={};i.App=function(){this.btnShare=$(".btn-share"),this.blogLogo=$(".blog-logo"),this.mobileMenu=$(".mobile-menu select"),this.coverImage=$(".post-cover"),this.init=function(){$("body").fadeIn(500,function(){}),this.blogLogo.addClass("animated bounceInDown visible"),this.blogLogo.removeClass("hiding"),this.coverImage.addClass("animated fadeIn visible"),this.coverImage.removeClass("hiding"),$(".animated").appear(),$(document.body).on("appear",".animated",function(i,e){var t=$(this),n=t.data("animation");t.addClass(n+" visible"),t.removeClass("hiding")})},this.btnShare.on("click",function(i){i.preventDefault();var e=$(this).attr("href"),t=$(this).data("width"),n=$(this).data("height");window.open(e,"Podziel się","width="+t+",height="+n)}),this.mobileMenu.on("change",function(){window.location=$(this).find("option:selected").val()})},i=new i.App,i.init()});